# 🛠️ 설치된 AI 스킬 가이드 (User Reference)

이 문서는 현재 프로젝트에 설치된 AI 에이전트 전용 스킬들을 분야별로 요약한 가이드입니다.

### 🎯 1. 기획 (Planning)
| 스킬명 | 주요 기능 (한 줄 요약) |
| :--- | :--- |
| **find-skills** | 프로젝트에 필요한 새로운 AI 스킬을 검색하고 설치합니다. |
| **brainstorming** | 구현 전, 사용자 의도와 디자인 요구사항을 심층적으로 탐색합니다. |
| **writing-plans** | 복잡한 요구사항에 대해 실행 가능한 구체적인 기술 계획을 수립합니다. |
| **[wireframe-rules](./wireframe/wireframe-rules.md)** | Figma MCP 기반 와이어프레임 제작 시 브레이크포인트·레이아웃·컴포넌트·배지·설명패널 규칙을 정의합니다. |

### 🎨 2. 디자인 (Design)
| 스킬명 | 주요 기능 (한 줄 요약) |
| :--- | :--- |
| **frontend-design** | 고품질의 프로덕션 수준 프런트엔드 UI를 설계하고 구현합니다. |
...
| 스킬명 | 주요 기능 (한 줄 요약) |
| :--- | :--- |
| **copywriting** | 마케팅 목적에 부합하는 설득력 있는 문구 작성을 지원합니다. |
| **content-strategy** | 콘텐츠 전략 수립, 제작할 콘텐츠 결정 및 주제 선정 지원. |
